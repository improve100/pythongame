...
class Brick(pygame.sprite.Sprite):
	def __init__(self):
		...
		self.brick = pygame.image.load('./图片/scene/brick.png')
...
class Iron(pygame.sprite.Sprite):
	def __init__(self):
		pygame.sprite.Sprite.__init__(self)
		self.iron = pygame.image.load('./图片/scene/iron.png')
...
class Ice(pygame.sprite.Sprite):
	def __init__(self):
		pygame.sprite.Sprite.__init__(self)
		self.ice = pygame.image.load('./图片/scene/ice.png')
...
class River(pygame.sprite.Sprite):
	def __init__(self, kind=None):
		...
		self.rivers = ['./图片/scene/river1.png', './图片/scene/river2.png']
...
class Tree(pygame.sprite.Sprite):
	def __init__(self):
		pygame.sprite.Sprite.__init__(self)
		self.tree = pygame.image.load('./图片/scene/tree.png')
